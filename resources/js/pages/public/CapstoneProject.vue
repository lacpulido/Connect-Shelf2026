        ...
        >
            <div>
                ...
                <p class="mt-1 text-gray-600">
                    List of available capstone projects.
                </p>
            </div>
            ...
            <div class="divide-y">
                ...
                >
                    <div class="flex items-center justify-between gap-4">
                        ...
                        <a
                           :href="route('resources.capstone.show', { slug: project.slug })"
                            class="shrink-0 text-sm font-medium text-[#0C4B05] transition hover:text-[#093804] hover:underline"
                        >
                            View Details →
                        </a>
                    </div>
