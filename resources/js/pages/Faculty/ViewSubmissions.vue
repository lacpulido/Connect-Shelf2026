...
const submission = computed<SubmissionDetails>(() => page.props.submission)
                    ...
                    <BreadcrumbList>
                        <BreadcrumbItem>
                            <Link
                                :href="
                                    backSection
                                        ? route('faculty.submissions.index', {
                                              project: submission.project_slug,
                                              open: backSection,
                                          })
                                        : route('faculty.submissions.index', {
                                              project: submission.project_slug,
                ...
                <div class="rounded-2xl border border-gray-200 bg-white p-6">
                    ...
                    >
                        <div
                            ...
                            :key="`${version.id}-${normalizeFileUrl(version.file_url) ?? 'no-file'}`"
                        ...
                        >
                            ...
                            <div class="mt-3">
                                <a
                                    v-if="normalizeFileUrl(version.file_url)"
                                    :href="normalizeFileUrl(version.file_url)!"
                                    target="_blank"
